...
var SingleStoreInsertBuilder = class {
	...
	shouldIgnore = false;
	constructor(table, session, dialect, columnList) {
		this.table = table;
	...
	values(values) {
		...
		return new SingleStoreInsertBase(this.table, values, this.shouldIgnore, this.session, this.dialect, this.columnList);
	}
};
var SingleStoreInsertBase = class extends __query_promise_ts.QueryPromise {
	static [__entity_ts.entityKind] = "SingleStoreInsert";
	config;
	constructor(table, values, ignore, session, dialect, columnList) {
		super();
		this.session = session;
		this.dialect = dialect;
		this.config = {
