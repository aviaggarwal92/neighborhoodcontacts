...
var NodeMsSqlPreparedQuery = class extends PreparedQuery {
	...
	async execute(placeholderValues = {}) {
		...
		return (this.rowMapper = this.rowMapper ?? (this.useJitMappers ? makeJitQueryMapper(fields, nullableObjectPaths) : makeDefaultQueryMapper(fields, nullableObjectPaths)))(rows.recordset);
	}
