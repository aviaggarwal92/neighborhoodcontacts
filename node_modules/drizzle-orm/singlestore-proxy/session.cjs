...
var PreparedQuery = class extends __singlestore_core_session_ts.SingleStorePreparedQuery {
	...
	async execute(placeholderValues = {}) {
		...
		const { fields, client, queryString, logger, nullableObjectPaths, customResultMapper, returningIds, generatedIds } = this;
	...
	async executeRqbV2(placeholderValues = {}) {
		...
		const rows = res[0];
		return this.useJitMappers ? (this.rowMapper = this.rowMapper ?? (0, __relations_ts.makeJitRqbMapper)(this.rqbConfig))(rows) : customResultMapper(rows);
	}
