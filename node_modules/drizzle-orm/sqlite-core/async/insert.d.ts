...
type SQLiteAsyncInsertBuilder<TTable extends SQLiteTable, TResultType extends 'sync' | 'async', TRunResult, TColumnList extends string[] | 'all' = 'all'> = SQLiteInsertBuilder<TTable, TRunResult, TColumnList, SQLiteAsyncInsertHKT & {
