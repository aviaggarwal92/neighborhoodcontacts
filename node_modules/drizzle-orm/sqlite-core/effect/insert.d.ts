...
type SQLiteEffectInsertBuilder<TTable extends SQLiteTable, TRunResult, TEffectHKT extends QueryEffectHKTBase = QueryEffectHKTBase, TColumnList extends string[] | 'all' = 'all'> = SQLiteInsertBuilder<TTable, TRunResult, TColumnList, SQLiteEffectInsertHKT<TEffectHKT>>;
