...
import { PreparedQueryConfig, SQLiteExecuteMethod, SQLitePreparedQuery, SQLiteSession } from "../session.cjs";
...
declare abstract class SQLiteEffectSession<TRunResult, TEffectHKT extends QueryEffectHKTBase = QueryEffectHKTBase, TRelations extends AnyRelations = EmptyRelations> extends SQLiteSession<TRunResult, TRelations> {
  ...
  abstract transaction<A, E, R>(transaction: (tx: SQLiteEffectTransaction<TEffectHKT, TRunResult, TRelations>) => Effect.Effect<A, E, R>): Effect.Effect<A, E | SqlError, R>;
}
...
declare const migrate: <TEffectHKT extends QueryEffectHKTBase>(migrations: MigrationMeta[], session: SQLiteEffectSession<any, TEffectHKT, EmptyRelations>, config?: string | Omit<MigrationConfig, "migrationsFolder"> | undefined) => Effect.Effect<undefined, SqlError | MigratorInitError | TEffectHKT["error"], TEffectHKT["context"]>;
//#endregion
