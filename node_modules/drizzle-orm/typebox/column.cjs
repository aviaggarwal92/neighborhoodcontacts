...
var TBuffer = class {
	constructor() {
		return typebox.default.Refine(typebox.default.Unsafe({ type: "buffer" }), (value) => value instanceof Buffer, () => "not a Buffer");
	}
};
var TDate = class {
	constructor() {
		return typebox.default.Refine(typebox.default.Unsafe({ type: "date" }), (value) => value instanceof Date, () => "not a Date");
	}
};
...
var TBigIntString = class {
	constructor() {
		return typebox.default.Refine(typebox.default.Unsafe({ type: "bigint-string" }), (value) => {
...
var TUnsignedBigIntString = class {
	constructor() {
		return typebox.default.Refine(typebox.default.Unsafe({ type: "unsigned-bigint-string" }), (value) => {
			if (typeof value !== "string" || !/^\d+$/.test(value)) return false;
			const bigint = BigInt(value);
			if (bigint < 0n || bigint > require_utils.CONSTANTS.INT64_MAX) return false;
			return true;
