...
var TursoDatabaseSession = class TursoDatabaseSession extends __sqlite_core_async_session_ts.SQLiteAsyncSession {
	...
	async transaction(transaction, config) {
		let clientTx = this.client.transactionAsync(async (txClient) => {
			const session = new TursoDatabaseSession(txClient, this.dialect, this.relations, this.options);
			return await transaction(new TursoDatabaseTransaction("async", this.dialect, session, this.relations));
		});
