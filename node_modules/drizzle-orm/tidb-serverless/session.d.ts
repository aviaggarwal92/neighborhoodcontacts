...
declare class TiDBServerlessSession<TRelations extends AnyRelations> extends MySqlAsyncSession<TiDBServerlessQueryResultHKT, TRelations> {
  private baseClient;
  private relations;
  private options;
  ...
  transaction<T>(transaction: (tx: TiDBServerlessTransaction<TRelations>) => Promise<T>, config?: MySqlTransactionConfig): Promise<T>;
}
declare class TiDBServerlessTransaction<TRelations extends AnyRelations> extends MySqlAsyncTransaction<TiDBServerlessQueryResultHKT, TRelations> {
  static readonly [entityKind]: string;
