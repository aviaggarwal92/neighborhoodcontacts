...
var PgEffectDatabase = class {
	...
	with(...queries) {
		...
		*/
		...
		function insert(table, ...columns) {
			return new PgInsertBuilder(table, self.session, self.dialect, queries, void 0, columns.length ? columns : void 0, PgEffectInsertBase);
		}
		/**
	...
	*/
	...
	insert(table, ...columns) {
		return new PgInsertBuilder(table, this.session, this.dialect, void 0, void 0, columns.length ? columns : void 0, PgEffectInsertBase);
	}
	/**
	* Creates a delete query.
	*
