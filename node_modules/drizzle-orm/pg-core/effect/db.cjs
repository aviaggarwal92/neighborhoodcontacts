...
var PgEffectDatabase = class {
	...
	with(...queries) {
		...
		*/
		...
		function insert(table, ...columns) {
			return new __pg_core_query_builders_insert_ts.PgInsertBuilder(table, self.session, self.dialect, queries, void 0, columns.length ? columns : void 0, __pg_core_effect_insert_ts.PgEffectInsertBase);
		}
		/**
	...
	*/
	...
	insert(table, ...columns) {
		return new __pg_core_query_builders_insert_ts.PgInsertBuilder(table, this.session, this.dialect, void 0, void 0, columns.length ? columns : void 0, __pg_core_effect_insert_ts.PgEffectInsertBase);
	}
	/**
	* Creates a delete query.
	*
