...
var PgAsyncDatabase = class {
	...
	with(...queries) {
		...
		*/
		...
		function insert(table, ...columns) {
			return new __pg_core_query_builders_index_ts.PgInsertBuilder(table, self.session, self.dialect, queries, void 0, columns.length ? columns : void 0, require_pg_core_async_insert.PgAsyncInsertBase);
		}
		/**
	...
	*/
	...
	insert(table, ...columns) {
		return new __pg_core_query_builders_index_ts.PgInsertBuilder(table, this.session, this.dialect, void 0, void 0, columns.length ? columns : void 0, require_pg_core_async_insert.PgAsyncInsertBase);
	}
	/**
	* Creates a delete query.
	*
