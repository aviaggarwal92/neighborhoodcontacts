...
function mapLibSQLTransactionBehavior(behavior) {
	switch (behavior) {
		case void 0: return;
		case "deferred": return "deferred";
		case "immediate": return "write";
		case "exclusive": throw new Error("Exclusive transactions are not supported by driver");
		case "concurrent": throw new Error("Concurrent transactions are not supported by driver");
	}
}
