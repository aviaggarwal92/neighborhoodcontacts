...
declare class OPSQLiteSession<TRelations extends AnyRelations> extends SQLiteAsyncSession<'async', OPSQLiteRunResult, TRelations> {
  ...
  private logger;
  private cache;
  constructor(client: DB, dialect: SQLiteDialect, relations: TRelations, options?: OPSQLiteSessionOptions);
  ...
  transaction<T>(transaction: (tx: OPSQLiteTransaction<TRelations>) => T | Promise<T>, config?: SQLiteTransactionConfig): Promise<T>;
}
declare class OPSQLiteTransaction<TRelations extends AnyRelations> extends SQLiteAsyncTransaction<'async', OPSQLiteRunResult, TRelations> {
  static readonly [entityKind]: string;
  transaction<T>(transaction: (tx: OPSQLiteTransaction<TRelations>) => T | Promise<T>): Promise<T>;
}
//#endregion
