...
var TursoDatabaseSyncSession = class TursoDatabaseSyncSession extends SQLiteAsyncSession {
	...
	async transaction(transaction, config) {
		let clientTx = this.client.transactionAsync(async (txClient) => {
			const session = new TursoDatabaseSyncSession(txClient, this.dialect, this.relations, this.options);
			return await transaction(new TursoDatabaseSyncTransaction("async", this.dialect, session, this.relations));
		});
