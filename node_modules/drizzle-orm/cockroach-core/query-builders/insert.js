...
var CockroachInsertBuilder = class {
	...
	constructor(table, session, dialect, withList, columnList) {
		this.table = table;
	...
	values(values) {
		...
		return new CockroachInsertBase(this.table, values, this.session, this.dialect, this.withList, false, this.columnList);
	}
	select(selectQuery) {
		...
		return new CockroachInsertBase(this.table, select, this.session, this.dialect, this.withList, true, this.columnList);
	}
};
