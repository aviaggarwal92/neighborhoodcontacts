...
type CockroachInsertValue<TTable extends CockroachTable<TableConfig>, OverrideT extends boolean = false, TColumnsList extends string[] | 'all' = 'all', TModel extends Record<string, any> = InferInsertModel<TTable, {
  dbColumnNames: false;
  override: OverrideT;
}>> = { [K in keyof TModel as TColumnsList extends 'all' ? K : Extract<K, TColumnsList[number]>]: TModel[K] | SQL | Placeholder } & {};
type CockroachInsertSelection<TTable extends CockroachTable<TableConfig>, TColumnsList extends string[] | 'all' = 'all', TModel extends Record<string, unknown> = InferInsertModel<TTable>> = { [K in keyof TModel as TColumnsList extends 'all' ? K : Extract<K, TColumnsList[number]>]: AnyCockroachColumn | SQL | SQL.Aliased | TModel[K] } & {};
...
type ValidateInsertSelectionKey<TTable extends CockroachTable<TableConfig>, TSelection extends CockroachInsertSelection<any>, K extends keyof TSelection> = K extends keyof InferInsertModel<TTable> ? TSelection[K] : K extends keyof InferInsertModel<TTable, {
  override: true;
