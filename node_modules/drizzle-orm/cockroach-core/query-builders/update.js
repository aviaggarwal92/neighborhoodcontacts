...
import { getTableLikeName, mapUpdateSet, orderSelectedFields, resolveNullableObjectPaths } from "../../utils.js";
...
var CockroachUpdateBase = class extends QueryPromise {
	...
	*/
	...
	_prepare(name, generateName = false) {
		...
		preparedQuery.nullableObjectPaths = this.config.returning ? resolveNullableObjectPaths(this.config.returning, this.joinsNotNullableMap) : void 0;
