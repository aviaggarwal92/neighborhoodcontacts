...
type RequiredInsertKeys<TTable extends Table, TColumns extends Record<string, Column> = TTable['_']['columns']> = { [K in keyof TColumns & string]: RequiredKeyOnly<K, TColumns[K]> }[keyof TColumns & string];
//#endregion
export { AnyTable, InferEnum, InferInsertModel, InferModel, InferModelFromColumns, InferSelectModel, InferTableColumnsModels, MapColumnName, RequiredInsertKeys, Table, TableConfig, TableTypeConfig, UpdateTableConfig, getTableName, getTableUniqueName, isTable };
